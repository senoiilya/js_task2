...
import { Button, Input, LoginForm, MainLayout, H1, Text, TextLink, HeaderForm, Navigate} from "../style";
...
export const SignIn = () => {
  ...
  const [type, setType] = useState(2) //1 - login, 2 - sign up  
     ...
     <HeaderForm>
      ...
      <Navigate>
        <ul>
          ...
          <li style={{visibility: 'hidden'}}><Button onClick={() => navigate("/signin")}>Зарегистрироваться</Button></li>
        </ul>
      </Navigate>
    </HeaderForm>
    <MainLayout>
